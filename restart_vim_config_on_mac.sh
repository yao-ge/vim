...
brew update
brew upgrade
brew install build-essential cmake vim-nox python3-dev clang libclang-dev clang-tidy clang-format
brew install mono-complete nodejs default-jdk npm gnutls-bin xdg-utils curl go
brew autoremove
